...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k+kn}{import} \PY{n+nn}{requests}
        ...
        \PY{k+kn}{from} \PY{n+nn}{gensim}\PY{n+nn}{.}\PY{n+nn}{summarization} \PY{k}{import} \PY{n}{summarize}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{url} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{https://timesofindia.indiatimes.com/sports/cricket/icc\PYZhy{}world\PYZhy{}cup/icc\PYZhy{}world\PYZhy{}cup\PYZhy{}another\PYZhy{}super\PYZhy{}over\PYZhy{}should\PYZhy{}decide\PYZhy{}the\PYZhy{}winner\PYZhy{}instead\PYZhy{}of\PYZhy{}boundaries\PYZhy{}says\PYZhy{}sachin\PYZhy{}tendulkar/articleshow/70248885.cms}\PY{l+s+s1}{\PYZsq{}}
        \PY{n}{page} \PY{o}{=} \PY{n}{requests}\PY{o}{.}\PY{n}{get}\PY{p}{(}\PY{n}{url}\PY{p}{)}\PY{o}{.}\PY{n}{text}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{n}{soup} \PY{o}{=} \PY{n}{BeautifulSoup}\PY{p}{(}\PY{n}{page}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{headline} \PY{o}{=} \PY{n}{soup}\PY{o}{.}\PY{n}{find}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{arttitle}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{get\PYZus{}text}\PY{p}{(}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{n}{headline}\PY{p}{)}
\end{Verbatim}
...
ICC World Cup: Another Super Over should decide the winner instead of boundaries, says Sachin Tendulkar
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{} Get text from all \PYZlt{}p\PYZgt{} tags.}
        \PY{n}{p\PYZus{}tags} \PY{o}{=} \PY{n}{soup}\PY{o}{.}\PY{n}{find\PYZus{}all}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{p}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{c+c1}{\PYZsh{} Get the text from each of the \PYZdq{}p\PYZdq{} tags and strip surrounding whitespace.}
        \PY{n}{p\PYZus{}tags\PYZus{}text} \PY{o}{=} \PY{p}{[}\PY{n}{tag}\PY{o}{.}\PY{n}{get\PYZus{}text}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{strip}\PY{p}{(}\PY{p}{)} \PY{k}{for} \PY{n}{tag} \PY{o+ow}{in} \PY{n}{p\PYZus{}tags}\PY{p}{]}
        \PY{n}{p\PYZus{}tags\PYZus{}text}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}7}]:} ["Refrain from posting comments that are obscene, defamatory or inflammatory, and do not indulge in personal attacks, name calling or inciting hatred against any community. Help us delete comments that do not follow these guidelines by marking them offensive. Let's work together to keep the conversation civil.",
         '',
         'Copyright © 2019 Bennett, Coleman \& Co. Ltd. All rights reserved. For reprint rights: Times Syndication Service']
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{match} \PY{o}{=} \PY{n}{soup}\PY{o}{.}\PY{n}{find}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{div}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{class\PYZus{}} \PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Normal}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{match}\PY{o}{.}\PY{n}{prettify}\PY{p}{(}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
<div class="Normal">
 NEW DELHI:
 <a class="key\_underline" href="https://timesofindia.indiatimes.com/topic/Sachin-Tendulkar">
  Sachin Tendulkar
 </a>
 on Tuesday endorsed a second
 <a class="key\_underline" href="https://timesofindia.indiatimes.com/topic/Super-Over">
  Super Over
 </a>
 ...
 <a class="key\_underline" href="https://timesofindia.indiatimes.com/topic/Rohit-Sharma">
  Rohit Sharma
 </a>
 ,
 <a class="key\_underline" href="https://timesofindia.indiatimes.com/topic/Gautam-Gambhir">
  Gautam Gambhir
 </a>
 and
 <a class="key\_underline" href="https://timesofindia.indiatimes.com/topic/Yuvraj-Singh">
  Yuvraj Singh
 </a>
 ...
 <a class="key\_underline" href="https://timesofindia.indiatimes.com/topic/Virat-Kohli">
  Virat Kohli
 </a>
 ...
 <a class="key\_underline" href="https://timesofindia.indiatimes.com/topic/Mahendra-Singh-Dhoni">
  Mahendra Singh Dhoni
 </a>
 was sent at number seven with
 <a class="key\_underline" href="https://timesofindia.indiatimes.com/topic/Hardik-Pandya">
  Hardik Pandya
 </a>
 ...
 <br/>
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{n}{text} \PY{o}{=} \PY{n}{match}\PY{o}{.}\PY{n}{get\PYZus{}text}\PY{p}{(}\PY{p}{)}
...
Read this story in Marathi
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{n}{summary} \PY{o}{=} \PY{n}{summarize}\PY{p}{(}\PY{n}{text}\PY{p}{,} \PY{n}{ratio}\PY{o}{=}\PY{l+m+mf}{0.3}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{n+nb}{print}\PY{p}{(}\PY{n}{summary}\PY{p}{)}
\end{Verbatim}
